    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        ...
        >
          ...
          {/* TABLEAU STYLÉ AVEC DIVS pour assurer la fusion dans le PDF */}
          <div className="w-full mb-6 border border-gray-400">
            ...
            {/* Corps du tableau */}
            <div className="flex">
              {/* Cellule fusionnée pour le nom */}
              <div className="flex-1 border-r border-gray-400 flex items-center justify-center py-2 px-3 font-medium text-center">
                {child.nom + " " + child.prenom}
              </div>
              
              {/* Colonne des mois et montants */}
              <div className="flex-2 flex flex-col">
                {paiements.map((p, idx) => (
                  <div key={idx} className="flex border-b last:border-b-0 border-gray-400">
